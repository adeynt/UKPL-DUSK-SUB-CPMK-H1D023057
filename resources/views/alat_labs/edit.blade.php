    ...
    <div class="py-12">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white p-6 shadow-sm sm:rounded-lg">
                ...
                <form action="{{ route('alat-lab.update', $alat_lab) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="kode_alat" id="kode-input"
                               value="{{ old('kode_alat', $alat_lab->kode_alat) }}"
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="nama_alat" id="nama-input"
                               value="{{ old('nama_alat', $alat_lab->nama_alat) }}"
                               class="w-full border-gray-300 rounded-md shadow-sm px-3 py-2
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="lokasi" id="lokasi-input"
                               value="{{ old('lokasi', $alat_lab->lokasi) }}"
                               class="w-full border-gray-300 rounded-md shadow-sm px-3 py-2
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" name="jumlah" id="jumlah-input"
                               value="{{ old('jumlah', $alat_lab->jumlah) }}"
                               min="0"
                               class="w-full border-gray-300 rounded-md shadow-sm px-3 py-2
                    ...
                    <div class="mb-4">
                        ...
                        <select name="kondisi" id="kondisi-select"
                            ...
                            {{-- Mempertahankan nilai old('kondisi') atau nilai dari model $alat_lab --}}
                            @foreach(['Baik','Rusak Ringan','Rusak Berat'] as $k)
                                <option value="{{ $k }}" @selected(old('kondisi', $alat_lab->kondisi) == $k)>
                                    {{ $k }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    {{-- Tombol Update --}}
                    <x-primary-button type="submit" dusk="submit-update">
                        Update Data Alat
                    </x-primary-button>
